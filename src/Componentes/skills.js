...
<div className="skills" id="skills">
    <div className="skillcontent">
      <h1>Conociento</h1>
      <p>En estas estadisticas me baso en en conocimiento aproximado de :
        basico, intermedio y Avanzado ya que es imposible medir con exactitud
        el porcentaje de conocimiento</p>
